...
from .models import (BaseChain,Country, OtherVariant,ContactClient,Calculation,BrandChain,TypeDelivery,DeliveryRate,Client)
...
tuple_models_adm_pnl=(Calculation,Client,ContactClient,Country)
